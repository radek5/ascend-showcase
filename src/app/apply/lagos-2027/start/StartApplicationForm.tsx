...
type Lagos2027StartApplicationFormProps = {
  accountEmail: string;
};

export default function Lagos2027StartApplicationForm({
  accountEmail,
}: Lagos2027StartApplicationFormProps) {
      ...
      <section className="mx-auto grid max-w-7xl gap-10 px-6 py-14 lg:grid-cols-[1fr_340px] lg:px-8">
        <div>
          ...
          <form onSubmit={handleSubmit} className="grid gap-6 sm:grid-cols-2">
            ...
            {/*
  The verified applicant account email is authoritative.

  Phone remains here temporarily because the application
  creation endpoint still uses it for duplicate protection.
*/}
              ...
              <div className="mt-4 grid gap-4 sm:grid-cols-2">
                <label className="space-y-2">
                  ...
                  <input
                    ...
                    value={accountEmail}
                    readOnly
                    className="w-full cursor-not-allowed rounded-xl border border-white/10 bg-white/[0.025] px-4 py-4 text-white/60 outline-none"
                  />

                  <span className="block text-xs leading-5 text-white/35">
                    This is the verified email address linked to your
          ...
          <div className="sticky top-8 rounded-2xl border border-white/10 bg-white/[0.03] p-6">
            ...
            <div className="mt-6 rounded-xl border border-[#c7ff2f]/15 bg-[#c7ff2f]/[0.05] p-4">
              ...
              <p className="mt-3 text-sm leading-6 text-white/70">
                There is no application fee or assessment fee for the
                REVELATIONX1 Lagos 2027 Men&apos;s Football Showcase.
              </p>
